...
To find the constant term, recall that $e_i = y_i - \widehat{y}_i$,

In deviations form, this means $e_i = y_i - b x_i$ or, rearranging,

$$y_i = bx_i + e_i$$

(This just says that the true $y$ is equal to the prediction, plus the residual)

---

Expanding $y$ and $x$ back to their original forms, we have

$$y_i - \bar y = b(x_i - \bar x)$$
Rearranging, this becomes

$$y_i = \underbrace{(\bar y - b \bar x)}_{\text{Constant term}} + b x_i$$

Thus, the constant term, and our estimate of $\alpha$, is
