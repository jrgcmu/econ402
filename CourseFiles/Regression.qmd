...
To find the constant term, note that in deviations form, $e_i = y_i - b x_i$, or $y_i = b x_i + e_i$

Expanding $y$ and $x$ back into their original forms, we have
...
Why? We know that (writing the variables as deviations from means):
