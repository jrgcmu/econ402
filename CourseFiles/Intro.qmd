...
**Syllabus:** It is your responsibility to read the *entire* syllabus to familiarize yourself with important policies and dates for the class

**Textbook:** Our main source will be my slides, so there is no required text. However, the "official" text for the course is *Introductory Econometrics: Intuition, Proof and Practice* by Zax. I have also listed some additional references in the syllabus for those who want to learn about topics beyond what we'll cover

**Software:** A lot of the work we do in this class will be on computers. We will use two different programs: [gretl](https://gretl.sourceforge.net/) and [R](https://www.r-project.org/). Both programs are free and run on any OS

---

Gretl is easier to use, but R has more powerful programming capabilities. You can use whichever you like better, though students interested in doing more advanced research should consider learning a little R. If you decide to use R, you might want to download [R Studio](https://posit.co/downloads), a free program which facilitates R programming

I will show you a little bit about how to use both programs in class. If you are interested in learning more, I have listed some additional resources in the syllabus

*Let me know as soon as possible if you have any difficulties installing these programs.*
...
$$\widehat{wage} = 183.95 + 29.66 \cdot educ$$
