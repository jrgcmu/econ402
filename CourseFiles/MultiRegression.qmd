...
2. Now we have the term $[1-Corr(x_1,x_2)^2]$ in the denominator. If $x_1$ and $x_2$ are highly correlated, this term will be small, which tends to make $V(b_1)$ *larger*
